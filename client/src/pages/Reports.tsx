    ...
    <div className="space-y-6">
        ...
        data.expensesByCategory.length === 0 && (
          <div className="bg-white p-12 rounded-lg shadow-sm border text-center">
            ...
            <p className="text-gray-600 mb-6">
              Não há transações para o período selecionado. Adicione algumas
              transações para ver os relatórios.
            </p>
                  ...
                  <div className="text-center">
                    ...
                    <p
                      className={`text-3xl font-bold ${
                        (data.monthlyData[0]?.balance || 0) >= 0
                          ? "text-green-600"
                          : "text-red-600"
                      }`}
                    >
      ...
      {activeReport === "comparison" && (
        <PerformanceComparison
          selectedPeriod={
            viewMode === "monthly" ? selectedMonth : selectedPeriod
          }
          budgetId={activeBudget?.budget?.id}
        />
      )}
                    ...
                    {data.topExpenses.map((expense, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500 hidden md:table-cell">
                          {formatCurrency(
                            expense.amount / expense.transactions
                          )}
                        </td>
                      </tr>
                    ))}
